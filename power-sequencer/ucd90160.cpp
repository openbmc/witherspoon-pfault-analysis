    ...
    for (const auto& gpiConfig : gpiConfigs)
    {
        ...
        if (gpiStatus == Value::low)
        {
            ...
            report<PowerSequencerPGOODFault>(
                    xyz::openbmc_project::Power::Fault::
                    PowerSequencerPGOODFault::INPUT_NUM(gpiNum),
                    xyz::openbmc_project::Power::Fault::
                    PowerSequencerPGOODFault::INPUT_NAME(gpiName.c_str()),
                    xyz::openbmc_project::Power::Fault::
                    PowerSequencerPGOODFault::INPUT_STATUS(status),
                    xyz::openbmc_project::Power::Fault::
                    PowerSequencerPGOODFault::STATUS_WORD(statusWord),
                    xyz::openbmc_project::Power::Fault::
                    PowerSequencerPGOODFault::MFR_STATUS(mfrStatus));
...
void UCD90160::createPowerFaultLog()
{
    ...
    report<PowerSequencerFault>(
            xyz::openbmc_project::Power::Fault::
            PowerSequencerFault::STATUS_WORD(statusWord),
            xyz::openbmc_project::Power::Fault::
            PowerSequencerFault::MFR_STATUS(mfrStatus));
}
