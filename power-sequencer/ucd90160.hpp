...
class UCD90160 : public Device
{
    public:
         ...
         */
        UCD90160(size_t instance, sdbusplus::bus::bus& b);
    ...
    private:
         ...
         *
         * @param[in] device - pointer to an instance of this
         *                     class
         *
         * @param[in] callout - the GPU callout string
         */
        static void gpuPGOODError(
         ...
         *                   /dev/gpiochip1
         */
        std::experimental::filesystem::path findGPIODevice(
         ...
         *
         * @param config - the GPIOConfig entry to use
         *
         ...
         * is wired into the chip, and then then the specific
         ...
         * @param[in] callout - error type and name tuple
         */
        inline void setPartCallout(PartCallout& callout)
        {
