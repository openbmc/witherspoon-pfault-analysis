...
class PowerSupply : public Device
{
    ...
    private:
         ...
         *
         * This will be incremented each time a read failure is encountered. If
         * it is incremented to FAULT_COUNT, an error will be logged. */
        size_t readFail = 0;
         ...
         *
         * This is the "INPUT FAULT OR WARNING" bit in the high byte, or the
         * VIN_UV_FAULT bit in the low byte in the STATUS_WORD command
         * response. If either of those bits are on, this will be incremented.
         */
        size_t inputFault = 0;
         ...
         *
         * This is incremented when the "IOUT_OC_FAULT" bit in the low byte
         * from the STATUS_WORD command response is on.
         */
         ...
         *
         * This is incremented when the 'VOUT_OV_FAULT" bit in the STATUS_WORD
         * command response is on.
         */
         ...
         *
         * This is incremented when the 'FAN_FAULT' bit in the STATUS_WORD
         * command response is on.
         */
        size_t fanFault = 0;
         ...
         *
         * This is incremented when the 'TEMPERATURE_FAULT_WARN' bit in the
         * STATUS_WORD command response is on, or if the 'OT_FAULT' bit in the
         * STATUS_TEMPERATURE command response is on.
         */
