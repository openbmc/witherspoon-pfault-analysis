...
PowerSupply::PowerSupply(const std::string& name, size_t inst,
    ...
    jsonFile(PSU_FRU_FILE_PATH),
    inventoryPMBusAccessType(witherspoon::pmbus::Type::Base)
{
...
void PowerSupply::load()
{
    try
    {
        ...
        getAccessType(fruJson.at("inventoryPMBusAccessType"));
    }
    catch (const std::exception& e)
    {
        log<level::ERR>("InternalFailure when parse the json file",
