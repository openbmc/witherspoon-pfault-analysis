...
void PowerSupply::updateInventory()
{
    ...
    Properties assetProps, versionProps;
    ...
    auto path = inventoryPath.substr(
            strlen(INVENTORY_OBJ_PATH),
            inventoryPath.size() - strlen(INVENTORY_OBJ_PATH));
