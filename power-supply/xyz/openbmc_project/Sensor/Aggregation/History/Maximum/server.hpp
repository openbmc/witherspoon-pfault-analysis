...
class Maximum
{
     ...
     *                 "xyz.openbmc_project.Sensor.Aggregation.History.Maximum.<value name>"
    ...
    private:
        ...
        static constexpr auto _interface = "xyz.openbmc_project.Sensor.Aggregation.History.Maximum";
