...
class RecordManager
{
    public:
        ...
        /**
         * @brief Converts a Linear Format power number to microWatts
         *
         ...
         *
         * @return int64_t the converted value in microWatts.
         */
        static int64_t linearToMicroWatts(uint16_t data);
