...
namespace Error
{
    struct PowerSupplyRuntimeOutputOvercurrent;
} // namespace Error
} // namespace Fault
} // namespace Power
} // namespace openbmc_project
...
namespace Fault
{
namespace _PowerSupplyRuntimeOutputOvercurrent
{
...
{
    static constexpr auto L = level::ERR;
    using STATUS_WORD = _PowerSupplyRuntimeOutputOvercurrent::STATUS_WORD;
    using STATUS_INPUT = _PowerSupplyRuntimeOutputOvercurrent::STATUS_INPUT;
    using STATUS_VOUT = _PowerSupplyRuntimeOutputOvercurrent::STATUS_VOUT;
    using STATUS_IOUT = _PowerSupplyRuntimeOutputOvercurrent::STATUS_IOUT;
    using MFR_SPECIFIC = _PowerSupplyRuntimeOutputOvercurrent::MFR_SPECIFIC;
    using CALLOUT_INVENTORY_PATH = xyz::openbmc_project::Common::Callout::Inventory::CALLOUT_INVENTORY_PATH;
    using metadata_types = std::tuple<STATUS_WORD, STATUS_INPUT, STATUS_VOUT, STATUS_IOUT, MFR_SPECIFIC, CALLOUT_INVENTORY_PATH>;
...
template <>
struct map_exception_type<sdbusplus::xyz::openbmc_project::Power::Fault::Error::PowerSupplyRuntimeOutputOvercurrent>
{
    using type = xyz::openbmc_project::Power::Fault::PowerSupplyRuntimeOutputOvercurrent;
};
