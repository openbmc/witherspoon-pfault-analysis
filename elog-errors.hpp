...
template <>
struct map_exception_type<sdbusplus::org::open_power::Witherspoon::Fault::Error::PowerOnErrorCPLDRegisterFail>
{
    using type = org::open_power::Witherspoon::Fault::PowerOnErrorCPLDRegisterFail;
};
