...
{
    static constexpr auto L = level::ERR;
    using STATUS_WORD = _PowerSupplyShouldBeOn::STATUS_WORD;
    using STATUS_INPUT = _PowerSupplyShouldBeOn::STATUS_INPUT;
    using STATUS_VOUT = _PowerSupplyShouldBeOn::STATUS_VOUT;
    using STATUS_IOUT = _PowerSupplyShouldBeOn::STATUS_IOUT;
    using MFR_SPECIFIC = _PowerSupplyShouldBeOn::MFR_SPECIFIC;
...
{
    static constexpr auto L = level::ERR;
    using STATUS_WORD = _PowerSupplyOutputOvercurrent::STATUS_WORD;
    using STATUS_INPUT = _PowerSupplyOutputOvercurrent::STATUS_INPUT;
    using STATUS_VOUT = _PowerSupplyOutputOvercurrent::STATUS_VOUT;
    using STATUS_IOUT = _PowerSupplyOutputOvercurrent::STATUS_IOUT;
    using MFR_SPECIFIC = _PowerSupplyOutputOvercurrent::MFR_SPECIFIC;
    using CALLOUT_INVENTORY_PATH = xyz::openbmc_project::Common::Callout::Inventory::CALLOUT_INVENTORY_PATH;
    using metadata_types = std::tuple<STATUS_WORD, STATUS_INPUT, STATUS_VOUT, STATUS_IOUT, MFR_SPECIFIC, CALLOUT_INVENTORY_PATH>;
...
{
    static constexpr auto L = level::ERR;
    using STATUS_WORD = _PowerSupplyOutputOvervoltage::STATUS_WORD;
    using STATUS_INPUT = _PowerSupplyOutputOvervoltage::STATUS_INPUT;
    using STATUS_VOUT = _PowerSupplyOutputOvervoltage::STATUS_VOUT;
    using STATUS_IOUT = _PowerSupplyOutputOvervoltage::STATUS_IOUT;
    using MFR_SPECIFIC = _PowerSupplyOutputOvervoltage::MFR_SPECIFIC;
    using CALLOUT_INVENTORY_PATH = xyz::openbmc_project::Common::Callout::Inventory::CALLOUT_INVENTORY_PATH;
    using metadata_types = std::tuple<STATUS_WORD, STATUS_INPUT, STATUS_VOUT, STATUS_IOUT, MFR_SPECIFIC, CALLOUT_INVENTORY_PATH>;
